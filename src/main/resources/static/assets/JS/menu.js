document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!token) {
        showError("Token JWT não encontrado.", "/src/main/resources/static/api/login.html", 0, true);
        return;
    }
    ...
    try {
        ...
        if (window.innerWidth > 768) {
            ...
            logoLink.href = "/src/main/resources/static/api/produto/home.html";
            const logoImg = document.createElement("img");
            logoImg.src = "/src/main/resources/static/assets/fotos/logo.png";
        ...
        const homeLink = createMenuItem("/src/main/resources/static/api/produto/home.html", "home.svg", "Inicio");
        menuContainer.appendChild(homeLink);

        const cadastroLink = createMenuItem("/src/main/resources/static/api/produto/cadastro.html", "box.svg", "Cadastro Produtos");
        menuContainer.appendChild(cadastroLink);

        const pesquisaLink = createMenuItem("/src/main/resources/static/api/produto/pesquisa.html", "lupa.svg", "Pesquisa Produtos");
        ...
        dadosUsuarioLink.href = userRoles.includes("ROLE_FUNCIONARIO") 
            ? "/src/main/resources/static/api/usuario/dados_user.html" 
            : "/src/main/resources/static/api/usuario/dados_empresa.html";
        dadosUsuarioLink.className = "menu-item";
        const dadosUsuarioIcon = document.createElement("img");
        dadosUsuarioIcon.src = "/src/main/resources/static/assets/fotos/svg/user.svg";
        ...
        if (userRoles.includes("ROLE_EMPRESA") || userRoles.includes("ROLE_ADMIN")) {
            const pesquisaFuncionarioLink = createMenuItem("/src/main/resources/static/api/usuario/pesquisa_user.html", "users.svg", "Pesquisa Funcionário");
            menuContainer.appendChild(pesquisaFuncionarioLink);

            const vincularFuncionarioLink = createMenuItem("/src/main/resources/static/api/usuario/vincular.html", "vinc.svg", "Vincular Funcionário");
            menuContainer.appendChild(vincularFuncionarioLink);

            const inativarFuncionarioLink = createMenuItem("/src/main/resources/static/api/usuario/inativar.html", "userRM.svg", "Inativar Funcionário");
        ...
        window.addEventListener('resize', function() {
            ...
            if (window.innerWidth <= 768 && logo) {
                ...
                // Recria a logo se a tela for grande o suficiente
                const logoLink = document.createElement("a");
                logoLink.href = "/src/main/resources/static/api/produto/home.html";
                const logoImg = document.createElement("img");
                logoImg.src = "/src/main/resources/static/assets/fotos/logo.png";
...
function createMenuItem(href, iconSrc, text) {
    ...
    menuIcon.src = `/src/main/resources/static/assets/fotos/svg/${iconSrc}`;
