document.addEventListener("DOMContentLoaded", function () {
    ...
    function carregarResultados() {
        ...
        // Adiciona eventos aos botões de exportação
        document.getElementById("exportPdfButton").addEventListener("click", function () {
            exportPDF(); // Exporta o PDF
            localStorage.removeItem("resultadosPesquisaUsuarios"); // Limpa o localStorage após a exportação
        });

        document.getElementById("exportExeButton").addEventListener("click", function () {
            exportXLS(); // Exporta o XLS
            localStorage.removeItem("resultadosPesquisaUsuarios"); // Limpa o localStorage após a exportação
        });
    }
