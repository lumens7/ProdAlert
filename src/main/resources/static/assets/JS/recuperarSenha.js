document.addEventListener('DOMContentLoaded', function() {
    ...
    redefinirSenhaForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                showSuccess('Senha alterada com sucesso! Redirecionando para login...', '/src/main/resources/static/api/usuario/login.html', 3000);
            } else {
                // Melhoria no tratamento de mensagens de erro
